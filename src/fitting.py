...
def fitloop_emg(diccio, ciclos, p_ini_emg, bounds_ini_emg, ciclos_grafico=None, cfg_bounds=None):
    """
    ...
    for ciclo in ciclos[1:]:
        try:
            ...
            popt_, pcov_ = fit_emg_ciclo(df_ch, p0_actual, bounds_actual)
            resultados.append(popt_)
            covs.append(pcov_)
