...
# Función doble Voigt ajustada con gamma1, gamma2 y ratio como parámetros
...
file_path = r"C:\Users\guadi\OneDrive\Escritorio\UNI\5to año\trabajo final\azufre\datos Ka\SKa_9.dat"
data = pd.read_csv(file_path, skiprows=2, delim_whitespace=True) #ojo con el skiprows
...
motor1_0 = data.loc[ind_max, 'motor1']  # Posición en pasos de la Ka1
#motor1_0=4 #introducir a mano
...
param_text = (f"Centro (Ka1): {cen:.2f} ± {perr[0]:.2f} eV\n"
              ...
              f"Amplitud 2 (amp2): {amp2:.2f} ± {amp1 * perr[1] / (ratio**2):.2f}\n"    #REVISAR ERROR        
